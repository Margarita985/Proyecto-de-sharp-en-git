...
namespace RFC
{
	partial class Form3
	{
		...
		private void InitializeComponent()
		{
			...
			this.label5.Text = "Nombre del programa:";
			// 
			// label6
			// 
			...
			this.label6.Text = "Proyecto de sharp en git";
			// 
			// label7
			// 
			...
			this.label12.Text = "Mariana Margarita Gonzalez Zavala";
			// 
			// Form3
			// 
